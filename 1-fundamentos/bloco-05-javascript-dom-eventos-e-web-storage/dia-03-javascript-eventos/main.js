...
// Porque a primeira li contém a classe 'tech' e as outras não.
...
const redirect = () => {
    myWebpage.addEventListener('dblclick', () => window.open('https://jeancarlos-sc.github.io/', '_blank'));
}
redirect();
