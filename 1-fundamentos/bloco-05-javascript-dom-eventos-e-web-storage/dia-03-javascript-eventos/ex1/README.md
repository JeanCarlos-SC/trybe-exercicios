...
### Para realização da primeira parte de exercícios do dia, foram utilizados os códigos a seguir:
...
1. Crie uma função que adicione a classe 'tech' ao elemento `li` quando for clicado. Deve existir apenas um elemento com a classe 'tech';
